...
<body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Modelo de Regresión con TensorFlow.js</h1>
                ...
                <div class="container col-xxl-8 px-4 py-5 ">
                    <p>Visitas actuales: <span id="contador_ts"></span></p>
                    <p>Predicción de visitas futuras: <span id="prediccion_ts"></span></p>
                </div>
    ...
    <script src="./assets/ml_ts.js"></script>
